...
/*Section="Main"*/
CREATE TABLE [PRD_STORAGECONDITIONLOG]
(
    /*Section="Columns"*/
...
EXEC sp_addextendedproperty @name = N'MS_Description',
    @value = N'Storage Condition Log: Saklama koşulları bilgisi bu tabloda tutulacaktır., logs.',
    @level0type = N'SCHEMA',
    @level0name = N'dbo',
    @level1type = N'TABLE',
    @level1name = N'PRD_STORAGECONDITIONLOG',
    @level2type = NULL,
    @level2name = NULL
GO

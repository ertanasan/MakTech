...
{
    [OTDisplayName("Reconciliation Sale Total")]
    [DataContract]
    public class ReconciliationSaleTotal : ViewModelObject
    {
        private long _saleTotalID;
        private long _event;
        ...
        /*Section="Field-SaleTotalID"*/
        [ScaffoldColumn(false)]
        [OTRequired("Sale Total ID", null)]
        [OTDisplayName("Sale Total ID")]
        [DataMember]
        public long SaleTotalID
        {
            get
            {
                return _saleTotalID;
        ...
        /*Section="Field-CreditCardTotal"*/
        [OTRequired("Credit Card Total", null)]
        [OTDisplayName("Credit Card Total")]
        [DataMember]

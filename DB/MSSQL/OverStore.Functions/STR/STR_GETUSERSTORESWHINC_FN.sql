CREATE FUNCTION [dbo].[STR_GETUSERSTORESWHINC_FN]() RETURNS TABLE AS      
RETURN (      
 ...
 BranchWHInc AS
 (
  SELECT * FROM BranchesCTE
   UNION ALL
  SELECT 999, 'MERKEZ DEPO', 222, 4 WHERE dbo.SYS_GETCURRENTBRANCH_FN()=222
 )
 ...
 SELECT ST.STOREID,
   ...
   JOIN STR_STOREWHINC_VW ST ON C.BRANCHID = ST.BRANCH

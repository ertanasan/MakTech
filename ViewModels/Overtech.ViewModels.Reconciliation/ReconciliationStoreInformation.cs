...
{
    [OTDisplayName("Reconciliation Store Information")]
    [DataContract]
    public class ReconciliationStoreInformation : ViewModelObject
    {
        private long _reconciliationStoreInformationId;
        private long _event;
        ...
        /*Section="Field-ReconciliationStoreInformationId"*/
        [ScaffoldColumn(false)]
        [OTRequired("Reconciliation Store Information Id", null)]
        [OTDisplayName("Reconciliation Store Information Id")]
        [DataMember]
        public long ReconciliationStoreInformationId
        {
            get
            {
                return _reconciliationStoreInformationId;
            }
            set
            {
                _reconciliationStoreInformationId = value;
            }
        }

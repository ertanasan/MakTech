...
{
    [OTDataObject(Module = "Warehouse", ModuleShortName = "WHS", Table = "RETURNORDER", HasAutoIdentity = true, DisplayName = "Return Order", IdField = "ReturnOrderId")]
    [DataContract]
    public class ReturnOrder : DataModelObject
    {
        ...
        /*Section="Field-ReturnOrderId"*/
        [OTDataField("RETURNORDERID")]
        [DataMember]

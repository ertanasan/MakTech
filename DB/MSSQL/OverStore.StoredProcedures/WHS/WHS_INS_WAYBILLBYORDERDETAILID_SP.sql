CREATE PROCEDURE WHS_INS_WAYBILLBYORDERDETAILID_SP @StoreOrderDetailId int AS
BEGIN
 DECLARE @emptyguid nvarchar(40)
     SET @emptyguid = '00000000-0000-0000-0000-000000000000';
 
 DECLARE @eksikGelen nvarchar(2),
		 @fazlaGelen nvarchar(2);
	 SET @eksikGelen = 'MD';
	 SET @fazlaGelen = 'DM';
 ...
 DECLARE @emptydate datetime;
	...
	--SELECT PRODUCT INTO #bannedProducts FROM PRD_PROPERTY WHERE PROPERTYTYPE = 4 AND VALUE_TXT = '1'

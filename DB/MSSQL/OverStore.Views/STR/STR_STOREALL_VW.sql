CREATE VIEW [dbo].[STR_STOREALL_VW] AS 
SELECT S.STOREID, S.STORE_NM, ACTIVE_FL, PRODUCTION_FL, S.OPENING_DT, S.CLOSING_DT, B2.BRANCH_NM REGION_NM
 ...
 GROUP BY S.STOREID, S.STORE_NM, ACTIVE_FL, PRODUCTION_FL, S.OPENING_DT, S.CLOSING_DT, B2.BRANCH_NM 
...
{
    [OTDataObject(Module = "Reconciliation", ModuleShortName = "RCL", Table = "ADJUSTMENT", HasAutoIdentity = true, DisplayName = "Adjustment", IdField = "AdjustmentId")]
    [DataContract]
    public class Adjustment : DataModelObject
    {

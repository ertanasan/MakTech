...
@Component({
  selector: 'ot-stockout-product-detail',
  templateUrl: './stockout-product-detail.component.html',
  styleUrls: ['./stockout-product-detail.component.css']
})

export class StockoutProductDetailComponent extends ListScreenBase<any> implements OnInit, OnDestroy {

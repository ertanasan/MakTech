...
@Component({
  selector: 'ot-stock-tracking-dialog',
  templateUrl: './stock-tracking-dialog.component.html',
  styleUrls: ['./stock-tracking-dialog.component.css']
})
export class StockTrackingDialogComponent extends ListScreenBase<any> implements OnInit, OnDestroy {

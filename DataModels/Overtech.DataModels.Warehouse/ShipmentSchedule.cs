...
{
    [OTDataObject(Module = "Warehouse", ModuleShortName = "WHS", Table = "SHIPMENTSCHEDULE", HasAutoIdentity = true, DisplayName = "Shipment Schedule", IdField = "ShipmentScheduleId")]
    [DataContract]
    public class ShipmentSchedule : DataModelObject
    {
        ...
        [OTDataField("SHIPMENTSCHEDULEID")]
        [DataMember]
        ...
        [OTDataField("SHIPMENTSCHEDULE_NM")]
        [DataMember]

CREATE PROCEDURE [dbo].[PRD_LST_STORESPRODUCTPERFORMANCE_SP]   
  @StartDate DATE,  
  @EndDate DATE,  
  @StartCompDate DATE,  
  @EndCompDate DATE  AS  
BEGIN  
	...
	SELECT P.CATEGORY_NM, 
		   ...
		   @lflstorecount LFLSTORE_CNT,
		   @lflstorecount + @newstorecount NEWSTORE_CNT,
		   @lflstorecount + @oldstorecount OLDSTORE_CNT,
		   @DayCount NEWDAY_CNT,
		   @CompDayCount OLDDAY_CNT
	 ...
	 GROUP BY P.CATEGORY_NM, P.CODE_NM, P.NAME_NM, P.SUBGROUP_NM, P.SUPERGROUP3_NM 
END